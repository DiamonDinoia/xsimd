...
namespace xsimd
{
    ...
    namespace kernel
    {
        ...
        // mulhi
        template <class A>
        XSIMD_INLINE batch<int8_t, A> mulhi(batch<int8_t, A> const& self, batch<int8_t, A> const& other, requires_arch<avx2>) noexcept
        {
        ...
        template <class A>
        XSIMD_INLINE batch<uint8_t, A> mulhi(batch<uint8_t, A> const& self, batch<uint8_t, A> const& other, requires_arch<avx2>) noexcept
        {

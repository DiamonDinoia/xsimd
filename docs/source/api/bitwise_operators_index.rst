...
+---------------------------------------+----------------------------------------------------+
| :cpp:func:`countl_zero`               | per slot count of leading zero bits                |
+---------------------------------------+----------------------------------------------------+
| :cpp:func:`countr_zero`               | per slot count of trailing zero bits               |
+---------------------------------------+----------------------------------------------------+
| :cpp:func:`bit_reverse`               | per slot bit order reversal                        |
+---------------------------------------+----------------------------------------------------+
...
+---------------------------------------+----------------------------------------------------+
| :cpp:func:`multishift`                | per byte unaligned bit field gather                |
+---------------------------------------+----------------------------------------------------+
